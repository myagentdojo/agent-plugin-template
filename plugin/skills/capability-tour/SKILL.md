...
3. `Available portable skills`: list `hello-world`, `skill-a`, `skill-b`, `capability-tour`, `dev-mode`, and `runtime-custody`, marking the first three Bun-backed and the last three model-only.
