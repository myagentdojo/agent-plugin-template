...
`);if(O==="hello"){let R=$(N,"--name")??"world";if(N.includes("--json"))return S(`${JSON.stringify({ok:!0,command:"hello",pluginVersion:PLUGIN_VERSION,message:`Hello, ${R}!`,sideEffects:"none",runId:W})}
`);return S(`Hello, ${R}!
