...
import { renderNativeCapabilityFixtureFor } from "./native-capability-fixture"
...
if (!options.dryRun) {
	...
	for (const file of fixtureFiles) writeFileSync(resolve(root, file.path), file.contents)
