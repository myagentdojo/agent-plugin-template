...
- KTD11. **Use immutable per-candidate refs for hosted qualification.** Push each publishing-system pull request SHA to a unique candidate ref in both canary repositories. Never advance one shared canary branch to qualify unmerged work. Governs R21-R22.
